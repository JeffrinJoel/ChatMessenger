...
function App() {
  ...
  const [messages, setMessages ] = useState([
    {
        text: "I'm ChatGPT, a computer program created by OpenAI. I'm a large language model designed to understand and generate human-like text based on the input I receive. I'm here to provide information, answer questions, assist with tasks, and engage in conversation on a wide range of topics. How can I assist you today?",
        isBot: true,
    }
]);
